...
module Data.FuzzyMatchBaseline.Tests (tests) where
...
import Data.FuzzyMatchBaseline

tests :: TestTree
tests = testGroup "Data.FuzzyMatchBaseline.Tests" [fuzzyMatchTests, heatMap, heatMapGrouping]
...
heatMap = testGroup "Heatmap"
  ...
  where
    mkTestCase :: Text -> PrimArray Int32 -> [Int] -> TestTree
